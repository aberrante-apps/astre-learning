...
// This is a webpage for Physics Products 
include ('header.php');
 ...
 *  COVER - for Physics
 --------------------------------------------------------------------->
 <div><img class="container zone cover" src="images/Physics.png"></div>
...
$sql = 'SELECT Products.id, Products.name, Products.price, Products.picture, ProductCategories.category_id
        ...
        WHERE ProductCategories.category_id = 5;';
...
if(mysqli_num_rows($result) > 0) 
{
    while ($row = mysqli_fetch_assoc($result))
    {
        ...
        <form method="POST" action="page_physics.php?action=add&id=<?php echo $row['id']; ?>">
