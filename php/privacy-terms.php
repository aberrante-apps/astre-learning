...
<!-- Button Functionality to be added later once pages are set up -->
<form method="POST" action="" >
<button type="submit" name="acceptConditions" class="btn bg-light border rounded-circle">Agree</button>
</form>
