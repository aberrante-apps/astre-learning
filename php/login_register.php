...
<br>
<h3>Assumptions</h3>
<p>When the User creates an account with Astre Learning, the Service Provider assumes that the User is over the age of 18. The Service Provider further assumes that the User has read through these Terms of Service and Privacy Agreement and can comprehend everything herein. With that said, the Service is merely a school project that doesn't actually sell anything or have any real world service or functionality beyond demonstrating that the students who put this website together know how web design works. Even so, this document has been drafted to give a decent look and feel that Lorem Ipsum text cannot properly impart. I am not a lawyer, so I have no idea if this document is actually legally binding. For the sake of argument, the User must treat this document as legally binding.</p>
<br>
<h3>Data Usage</h3>
<p>As required by the General Data Protection Regulation, the User has the right to know how their data will be used:</p>
<ul>
    <li>Most of the User's data will be stored on the Service Provider's database. Such data includes the User's name, email address, phone number, shopping cart contents, and order history.</li>
    <li>The User's credit card information will not be saved on the Service Provider's database. It will, however, be processed through Stripe, a third-party payment processor which probably has its own Terms of Service to examine.</li>
    ...
    <li>The User's order history will be saved as a record of past transactions. This will include billing and shipping information for each order, which will be used for billing and shipping all orders respectively.</li>
</ul>
<br>
