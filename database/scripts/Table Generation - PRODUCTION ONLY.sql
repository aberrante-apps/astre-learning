...
CREATE TABLE IF NOT EXISTS `ICS199Group03_prod`.`Products` (
  ...
  CONSTRAINT `fk_Products_ProductCategories`
    ...
    REFERENCES `ICS199Group03_prod`.`ProductCategories` (`cat_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `ICS199Group03_prod`.`OrderDetails`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `ICS199Group03_prod`.`OrderDetails` ;

CREATE TABLE IF NOT EXISTS `ICS199Group03_prod`.`OrderDetails` (
...
CREATE TABLE IF NOT EXISTS `ICS199Group03_prod`.`OrderedProducts` (
  ...
  CONSTRAINT `fk_OrderedProducts_OrderDetails1`
    ...
    REFERENCES `ICS199Group03_prod`.`OrderDetails` (`order_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
